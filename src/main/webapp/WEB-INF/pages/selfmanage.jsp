...
#bg{background-image:url(/WEB-INF/images/content/dotted.png);}
...
.line{height:2px;width:100%;background-image:url(/WEB-INF/images/left/line_bg.png);background-repeat:repeat-x;}
...
.custom dt{background-image:url(/WEB-INF/images/left/system.png)}
.channel dt{background-image:url(/WEB-INF/images/left/channel.png)}
.app dt{background-image:url(/WEB-INF/images/left/app.png)}
.cloud dt{background-image:url(/WEB-INF/images/left/cloud.png)}
.syetem_management dt{background-image:url(/WEB-INF/images/left/syetem_management.png)}
.source dt{background-image:url(/WEB-INF/images/left/source.png)}
.statistics dt{background-image:url(/WEB-INF/images/left/statistics.png)}
