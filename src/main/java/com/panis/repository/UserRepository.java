...
public interface UserRepository extends JpaRepository<UserTableEntity, Integer> {
    ...
    @Modifying
    @Transactional
    @Query("update UserTableEntity us set us.uName=:uName,us.uAge=:uAge,us.uSex=:uSex," +
            "us.phoneNumber=:phoneNumber,us.userName=:userName,us.password=:password," +
            "us.power=:power where us.uId = :uId")
